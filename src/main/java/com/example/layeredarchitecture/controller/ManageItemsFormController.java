...
//                pstm.executeUpdate();
                boolean isItemSaved = itemDAO.saveItem(new ItemDTO(code, description, unitPrice, qtyOnHand));
...
//                pstm.executeUpdate();
                boolean isUpdatedItem = itemDAO.updateItem(new ItemDTO(code, description, unitPrice, qtyOnHand));
